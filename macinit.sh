# This is extracted from https://github.com/thesephist/dotfiles
...
brew install zsh git vim emacs wget nodejs npm ruby python python3 youtube-dl golang make htop tmux gcc tree
